using Barin.Framework.Domain.DapperAttributes;
using Dapper;
...
public static partial class SqlMapperExtensions
{
    ...
    {
        if (entityToUpdate is IProxy && !(entityToUpdate as IProxy).IsDirty)
        {
            return false;
        }
    ...
    private static ISqlAdapter GetFormatter(IDbConnection connection)
    {
        ...
        return AdapterDictionary.ContainsKey(name) ? AdapterDictionary[name] : DefaultAdapter;
    }
